...
import com.righteous.and.stern.databinding.FridayPageBinding
...
class FridayPage : AppCompatActivity() {
    ...
    private fun setupLoadingDialog() {
        // 设置设备图标
        val imgLoad = binding.loadingDialog.root.findViewById<android.widget.ImageView>(R.id.imgLoad)
        imgLoad.setImageResource(R.drawable.ic_tues_device)
        
        // 设置旋转动画
        val imgLoading = binding.loadingDialog.root.findViewById<android.widget.ImageView>(R.id.img_loading)
