...
import com.mottled.quell.kill.databinding.ThursPageBinding
...
class ThursPage : AppCompatActivity() {
    ...
    private fun showLoadingDialog() {
        ...
        // 获取加载图片并启动旋转动画
        val loadingImage = binding.loadingDialog.root.findViewById<ImageView>(R.id.img_loading)
        val imgBack = binding.loadingDialog.root.findViewById<ImageView>(R.id.img_back)
